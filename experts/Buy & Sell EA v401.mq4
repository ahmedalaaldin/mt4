//+------------------------------------------------------------------+
//|   Buy & Sell EA v401 - v393 + ATR spike filter disabled (ATR_Spike_Multi=0): max signal frequency|
...
input double ATR_Spike_Multi    = 0.0;            // 0 = disabled: max signal frequency
...
input int    Magic_Number       = 4012057;        // v401 unique magic
input string Order_Comment      = "BSv401";
