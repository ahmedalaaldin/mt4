//+------------------------------------------------------------------+
//|   Buy & Sell EA v50 - v24 Signal + Higher Risk Scaling          |
//|   Entry: H1 EMA200 + H1 RSI 50-75 + BB 2.5SD lower touch       |
//|          + M5 RSI<40 + Stoch K&D<25 + bullish close             |
//|   Exit: TP = BB mid, SL = 1xATR                                |
//|   Changes: Risk_Pct=4.0%, Max_Daily_DD_Pct=8.0%                |
//|   Goal: Scale proven v24 signal for higher compounded returns   |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
...
input double Risk_Pct           = 4.0;            //Risk % per trade (raised from 2.0 to 4.0)
...
input int    Magic_Number       = 502025;         //Magic Number
input string Order_Comment      = "BSv50";        //Order comment
input double Max_Daily_DD_Pct   = 8.0;            //Daily drawdown guard (% of equity, raised from 4.0)
