//+------------------------------------------------------------------+
//|   Buy & Sell EA v64 - v51 + Looser signals for more trades      |
//|   Entry: H1 EMA200 + H1 RSI 50-75 + BB 2.0SD lower touch       |
//|          + M5 RSI<45 + RSI rising + Stoch K&D<30 + Bull 20%    |
//|   Exit: TP = BB mid, SL = 1xATR                                |
//|   Changes: BB=2.0SD, RSI<45, Stoch<30 (all loosened from v51)  |
//|   Goal: 100+ trades/year while keeping WR above 50%             |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "64.0"
#property strict
...
input double RSI_Buy            = 45.0;           //M5 RSI must be below this (loosened from 40)
input int    Stoch_K            = 5;              //Stochastic K period
input int    Stoch_D            = 3;              //Stochastic D period
input int    Stoch_Slowing      = 3;              //Stochastic slowing
input double Stoch_OB           = 30.0;           //Stochastic oversold level (loosened from 25)
...
input int    Magic_Number       = 642025;         //Magic Number
input string Order_Comment      = "BSv64";        //Order comment
