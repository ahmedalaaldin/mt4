//+------------------------------------------------------------------+
//|   Buy & Sell EA v397 - v393 + scale cap 3.0: double partial close + aggressive compounding|
...
input int    Magic_Number       = 3972057;        // v397 unique magic
input string Order_Comment      = "BSv397";
...
double GetRiskScale()
{
   ...
   return MathMax(Min_Scale, MathMin(3.0, scale));
}
