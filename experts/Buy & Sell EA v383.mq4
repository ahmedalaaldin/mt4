//+------------------------------------------------------------------+
//|   Buy & Sell EA v383 - H4_EMA_Fast=65 test (base v381, Max_Bars=22)   |
...
input int    H4_EMA_Fast_Period = 65;             // v383: test above 60
...
input int    Magic_Number       = 3832057;        // v383 unique magic
input string Order_Comment      = "BSv383";
