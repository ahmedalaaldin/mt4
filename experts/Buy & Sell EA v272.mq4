//+------------------------------------------------------------------+
//|   Buy & Sell EA v272 - Further widen H1 RSI upper limit          |
//|   Framework: H1 Direction / M5 Entry / Wider H1 RSI Max          |
//|   HYPOTHESIS: Pushing H1 RSI upper limit higher allows more      |
//|     qualifying H1 periods in strong trend conditions              |
//|     Buy: 40-85 (from 40-80 in v269)                              |
//|     Sell: 15-65 (from 20-60 in v269)                             |
//|     Same BB primary signal, NO secondary 2.0σ (v270 confirmed bad)|
//|   BASE: v269 CHAMPION (Calmar=17.77, Return=209%, 707 trades)    |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "272.0"
#property strict

#include <stdlib.mqh>

//--- Session (CONFIRMED OPTIMUM: 09:00-21:00)
...
//--- H1 RSI Gate - FURTHER WIDENED upper limit
input string H1RSI_SET          = "============"; //====== H1 RSI Gate ======
input int    H1_RSI_Period      = 14;
input double H1_RSI_Min         = 40.0;           // Same as v269
input double H1_RSI_Max         = 85.0;           // v272: widened from 80 to 85
input double H1_RSI_Min_Sell    = 15.0;           // v272: widened from 20 to 15
input double H1_RSI_Max_Sell    = 60.0;           // Same as v269

//--- BB Entry Signal (BB_Dev=2.5 NON-NEGOTIABLE, single band only)
...
input int    Magic_Number       = 2722057;
input string Order_Comment      = "BSv272";
...
void OnTick()
{
   ...
   // v272: H1 RSI upper limit further widened (Buy: 40-85, Sell: 15-60)
   ...
   //=== BUY: H4 removed, H1 EMA kept, wider H1 RSI max (40-85) ===
   if(h1Bull && stochBuy)
   {
   ...
   //=== SELL: H4 removed, H1 EMA kept, wider H1 RSI range (15-60) ===
   if(h1Bear && stochSell)
   {
