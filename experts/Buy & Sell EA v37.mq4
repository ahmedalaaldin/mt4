//+------------------------------------------------------------------+
//|   Buy & Sell EA v48 - v24 Signal + Aggressive Scaling           |
//|   Entry: H1 EMA200 + H1 RSI 50-75 + BB 2.5SD lower touch       |
//|          + M5 RSI<40 + Stoch K&D<25 + bullish close             |
//|   Exit: TP = BB mid, SL = 1xATR                                |
//|   Changes: Risk_Pct=2.5%, Max_Buys=5, Min_Bar_Gap=1            |
//|   Goal: Scale proven v24 signal for higher returns              |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
...
input int    Min_Bar_Gap        = 1;              //Min bars between entries (reduced from 2)
...
input double Risk_Pct           = 2.5;            //Risk % per trade (raised from 2.0)
input double Fixed_Lot          = 0.0;            //Fixed lot (0 = use Risk_Pct)
input int    Max_Buys           = 5;              //Max concurrent BUY positions (raised from 3)
...
input int    Magic_Number       = 482025;         //Magic Number
input string Order_Comment      = "BSv48";        //Order comment
