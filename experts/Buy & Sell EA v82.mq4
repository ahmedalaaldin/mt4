//+------------------------------------------------------------------+
//|   Buy & Sell EA v93 - BB 2.0SD for more trade frequency         |
//|   Entry: H4 EMA200 + H1 EMA200 + H1 RSI 50-75                  |
//|          + BB 2.0SD lower touch + M5 RSI<40 + RSI rising        |
//|          + Stoch K&D<25 + Bull body 20%                         |
//|   Exit: TP = BB mid, SL = 1xATR                                 |
//|   Change: BB_Dev 2.5 -> 2.0 for ~4x more signal frequency      |
//|   Goal: More trades (target 100-200/year) at ~55% WR            |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "93.0"
#property strict
...
input double BB_Dev             = 2.0;            //BB standard deviations (2.0 for more frequency)
...
input int    Magic_Number       = 932025;         //Magic Number
input string Order_Comment      = "BSv93";        //Order comment
