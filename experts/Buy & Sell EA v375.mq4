//+------------------------------------------------------------------+
//|   Buy & Sell EA v375 - Max_Bars=15 test   |
...
input int    H4_EMA_Fast_Period = 60;             // v375: confirmed optimal
...
input int    Max_Bars           = 15;             // v375: test Max_Bars=15
...
input int    Magic_Number       = 3752057;        // v375 unique magic
input string Order_Comment      = "BSv375";
