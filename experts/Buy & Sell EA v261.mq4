...
input double Trail_ATR_Multi    = 0.1;            // v261: very tight trail (0.3->0.1), SL near bbMid
...
input int    Magic_Number       = 2612057;
input string Order_Comment      = "BSv261";
