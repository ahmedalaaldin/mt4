//+------------------------------------------------------------------+
//|   Buy & Sell EA v379 - ATR_Spike_Multi=1.8 test (base v374)   |
...
input double ATR_Spike_Multi    = 1.8;            // v379: test tighter spike filter
...
input int    Magic_Number       = 3792057;        // v379 unique magic
input string Order_Comment      = "BSv379";
