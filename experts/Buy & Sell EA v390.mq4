//+------------------------------------------------------------------+
//|   Buy & Sell EA v390 - H4 dual-EMA alignment: fast(60)>slow(200) |
...
input int    Magic_Number       = 3902057;        // v390 unique magic
input string Order_Comment      = "BSv390";
...
void OnTick()
{
   ...
   // v390: H4 dual-EMA alignment — fast(60) must be above slow(200) for trend confirmation
