...
input double RSI_Buy            = 30.0;           // v503: 45->30 (extreme oversold = higher WR hypothesis)
...
input bool   Use_TwoBar_Pattern = false;          // v503: disable (first touch hypothesis)
...
input int    Magic_Number       = 5032057;        // v503 unique magic
input string Order_Comment      = "BSv503";
