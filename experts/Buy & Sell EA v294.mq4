//+------------------------------------------------------------------+
//|   Buy & Sell EA v294 - Extended Session (7-22 vs 9-21)           |
//|   BASE: v293/v280 CHAMPION (Calmar=18.43, Return=220.62%, 637 T) |
//|   CHANGE: Session_Start_Hour 9→7, Session_End_Hour 21→22         |
//|   RATIONALE:                                                      |
//|     v280 uses 9-21 (12 hour window). Extending to 7-22 (15 hours) |
//|     adds 3 extra hours of BB mean-reversion opportunity:          |
//|       7-9AM: Pre-London open — EUR/USD session ending, Asian      |
//|              ranges setting up, often good mean-reversion setups  |
//|       21-22: Post-NY close — low-vol consolidation, tight BBs     |
//|     MaxSpread=35 already filters out wide-spread illiquid hours.  |
//|     HYPOTHESIS: +25% session time → ~780-800 trades (vs 637),    |
//|     smoother equity curve, improved Calmar from 18.43 → ~21-22.  |
//|   SCOREBOARD:                                                      |
...
//|     v294: Extended session — TARGET >20                           |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "294.0"
#property strict

#include <stdlib.mqh>

//--- Session (KEY CHANGE: 9-21 → 7-22, +3 hours = +25% session time)
input string SESSION_SET        = "============"; //====== Session Settings ======
input int    Session_Start_Hour = 7;   // KEY CHANGE: was 9, now 7 (add pre-London 7-9AM)
input int    Session_End_Hour   = 22;  // KEY CHANGE: was 21, now 22 (add post-NY 21-22)
...
input int    Magic_Number       = 2942057;
input string Order_Comment      = "BSv294";
