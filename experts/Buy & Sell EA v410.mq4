//+------------------------------------------------------------------+
//|   Buy & Sell EA v410 - BB_Dev=2.3 (tighter bands, more signals)  |
//|   BASE: v393 ALL-TIME BEST (ratio=8.83) ✓                        |
//|                                                                   |
...
input double BB_Dev             = 2.3;            // v410: tighter bands = more touch events = more signals
...
input int    Magic_Number       = 4102057;        // v410 unique magic
input string Order_Comment      = "BSv410";
