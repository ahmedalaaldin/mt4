//+------------------------------------------------------------------+
//|   Buy & Sell EA v358 - H4 EMA(50) medium-term trend gate         |
...
input int    H4_EMA_Fast_Period = 20;             // v367: TEST faster H4 gate (50 in v358)
...
input int    Magic_Number       = 3672057;        // v367 unique magic
input string Order_Comment      = "BSv367";
