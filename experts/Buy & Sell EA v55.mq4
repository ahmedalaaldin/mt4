//+------------------------------------------------------------------+
//|   Buy & Sell EA v66 - v51 + Only BB loosened to 2.0SD          |
//|   Entry: H1 EMA200 + H1 RSI 50-75 + BB 2.0SD lower touch       |
//|          + M5 RSI<40 + RSI rising + Stoch K&D<25 + Bull 20%    |
//|   Exit: TP = BB mid, SL = 1xATR                                |
//|   Changes: BB_Dev=2.0 only (RSI<40, Stoch<25 kept strict)      |
//|   Goal: More BB touches while quality gates prevent bad trades   |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "66.0"
#property strict
...
input double RSI_Buy            = 40.0;           //M5 RSI must be below this (strict)
input int    Stoch_K            = 5;              //Stochastic K period
input int    Stoch_D            = 3;              //Stochastic D period
input int    Stoch_Slowing      = 3;              //Stochastic slowing
input double Stoch_OB           = 25.0;           //Stochastic oversold level (strict)
...
input int    Magic_Number       = 662025;         //Magic Number
input string Order_Comment      = "BSv66";        //Order comment
