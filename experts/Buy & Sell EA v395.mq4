//+------------------------------------------------------------------+
//|   Buy & Sell EA v395 - Scale cap 3.0: very aggressive compounding            |
...
input int    Magic_Number       = 3952057;        // v395 unique magic
input string Order_Comment      = "BSv395";
