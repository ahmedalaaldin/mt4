//+------------------------------------------------------------------+
//|   Buy & Sell EA v385 - ATR_Spike_MA=55 test (base v381, Max_Bars=22)   |
...
input int    ATR_Spike_MA_Period = 55;            // v385: test above 50 with Max_Bars=22
...
input int    Magic_Number       = 3852057;        // v385 unique magic
input string Order_Comment      = "BSv385";
