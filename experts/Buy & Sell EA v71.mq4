//+------------------------------------------------------------------+
//|   Buy & Sell EA v82 - BB 2.0SD for higher frequency             |
...
//|   Changes: BB loosened 2.5→2.0SD for 3-5x more signals         |
//|   Goal: Get 150-300 trades/yr while keeping ~50%+ WR            |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "82.0"
#property strict
...
input double BB_Dev             = 2.0;            //BB standard deviations (loosened from 2.5)
input double TP_Min_ATR         = 0.3;            //Min TP distance as ATR multiple
...
input int    Magic_Number       = 822025;         //Magic Number
input string Order_Comment      = "BSv82";        //Order comment
