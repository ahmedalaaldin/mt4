//+------------------------------------------------------------------+
//|   Buy & Sell EA v407 - Partial_Pct=0.10 (v393 was 0.20)|
...
input double Partial_Pct        = 0.10;           // v407: keep 90% in trail after stage1
...
input int    Magic_Number       = 4072057;        // v407 unique magic
input string Order_Comment      = "BSv407";
