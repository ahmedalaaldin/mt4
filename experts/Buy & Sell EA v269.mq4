//+------------------------------------------------------------------+
//|   Buy & Sell EA v269 - Wider H1 RSI range (keep H1 EMA dir)     |
//|   Framework: H1 Direction + wider H1 RSI / M5 Entry             |
//|   HYPOTHESIS: H1 RSI range 45-75/25-55 too tight, widening to   |
//|     Buy: 40-80 (from 45-75), Sell: 20-60 (from 25-55)          |
//|     More qualifying H1 periods → more M5 signals triggered      |
//|   BASE: v267 CHAMPION (Calmar=14.34, 609 trades)                |
//|     H4 direction still removed (from v267)                       |
//|     H1 EMA direction KEPT (unlike v268)                          |
//|     Only change: wider H1 RSI range                              |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "269.0"
#property strict
...
//--- H1 RSI Gate - WIDENED from v267 (45-75 → 40-80 buy, 25-55 → 20-60 sell)
...
input int    Magic_Number       = 2692057;
input string Order_Comment      = "BSv269";
...
void OnTick()
{
   ...
   // v269: H4 EMA direction removed (from v267), H1 EMA direction KEPT
   // Only change from v267: H1 RSI range widened (40-80 buy, 20-60 sell)
   ...
   // v269: H1 EMA direction kept, RSI range widened
   ...
   //=== BUY: H4 removed, H1 EMA direction kept, wider H1 RSI range ===
   if(h1Bull && stochBuy)
   {
   ...
   //=== SELL: H4 removed, H1 EMA direction kept, wider H1 RSI range ===
   if(h1Bear && stochSell)
   {
