//+------------------------------------------------------------------+
//|   Buy & Sell EA v51 - v24 Signal + Strong Body Filter           |
//|   Entry: H1 EMA200 + H1 RSI 50-75 + BB 2.5SD lower touch       |
//|          + M5 RSI<40 + Stoch K&D<25                             |
//|          + Strong bull body >= 50% of candle range              |
//|   Exit: TP = BB mid, SL = 1xATR                                |
//|   Goal: Higher WR by requiring strong momentum confirmation     |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
...
input double Body_Pct           = 0.5;            //Min bull body as fraction of candle range
...
input double Risk_Pct           = 2.5;            //Risk % per trade
...
input int    Magic_Number       = 512025;         //Magic Number
input string Order_Comment      = "BSv51";        //Order comment
...
void OnTick()
{
   ...
   // Strong bullish body: close > open AND body >= Body_Pct of full range
