//+------------------------------------------------------------------+
//|   Buy & Sell EA v101 - Streak-Based Risk Scaling                 |
//|   Framework: 4H Direction / 1H Structure / 5M Entry             |
//|   Base: v97 (no M15 filter, more trades) + streak protection     |
//|   Innovation:                                                    |
//|     - After 1 consecutive loss: risk = base × 0.5               |
//|     - After 2 consecutive losses: risk = base × 0.25            |
//|     - After 3+ consecutive losses: risk = base × 0.1            |
//|     - After any win: reset to full base risk                     |
//|   Goal: Preserve v97 returns (~280%) while cutting DD to <5%    |
//|   Key insight: v97 had 4 consec losses that drove 9.35% DD      |
//|   With streak scaling, that same streak costs <2% DD             |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "111.0"
#property strict
...
//--- Bollinger Bands (M5) - No M15 filter (same as v97 for more trades)
...
input double Risk_Pct           = 5.5;            //Base risk % per trade
...
input int    Magic_Number       = 1112025;        //Magic Number
input string Order_Comment      = "BSv111";       //Order comment
...
void OnTick()
{
   ...
   // No M15 filter (same as v97 — more trades, streak protection compensates)
