//+------------------------------------------------------------------+
//|   Buy & Sell EA v39 - H1 Trend + M5 RSI Dip (High Frequency)   |
//|   BUY: H1 EMA200 + H1 RSI 50-75 + M5 RSI<40 + bullish close   |
//|   No Stochastic, no BB lower-touch requirement                  |
//|   TP at BB midline (dynamic), SL = 1xATR                       |
//|   BB_Dev=2.5, Goal: 3-5x more trades than v35 with good PF     |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
...
input double TP_Min_ATR         = 0.5;            //Min TP distance as ATR multiple (relaxed)
...
input int    Magic_Number       = 392025;         //Magic Number
input string Order_Comment      = "BSv39";        //Order comment
...
void OnTick()
{
   ...
   // RSI dip below threshold with bullish candle close
   bool rsiDip    = (rsi1 < RSI_Buy);
