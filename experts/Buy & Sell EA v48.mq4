//+------------------------------------------------------------------+
//|   Buy & Sell EA v59 - Buy Only + 15% Body + 8% Risk            |
//|   Entry: H1 EMA200 + H1 RSI 50-75 + BB 2.5SD lower touch       |
//|          + M5 RSI<40 + RSI rising + Stoch K&D<25 + Bull 15%    |
//|   Exit: TP = BB mid, SL = 1xATR                                |
//|   Changes: Body_Pct=0.15 (from 0.2) for even more trades       |
//|   Goal: Test if WR holds above 55% with looser body filter      |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "59.0"
#property strict
...
input double Body_Pct           = 0.15;           //Min bull body as fraction of range (looser)
...
input int    Magic_Number       = 592025;         //Magic Number
input string Order_Comment      = "BSv59";        //Order comment
