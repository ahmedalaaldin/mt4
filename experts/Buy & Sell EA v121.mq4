//+------------------------------------------------------------------+
//|   Buy & Sell EA v121 - Even Wider Trail                          |
//|   Framework: 4H Direction / 1H Structure / 5M Entry             |
//|   Base: v120 (224.50%, 14.95% DD, 15.0x ratio)                  |
//|   Changes vs v120:                                               |
//|     - Trail_ATR_Multi: 1.5 (was 0.8) — wider trail to ride      |
//|       larger moves after partial close at BB mid                 |
//|   Hypothesis: v114→v120 wider trail added +6.7% return same DD; |
//|   continuing to 1.5 should push Return/DD ratio higher still     |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "131.0"
#property strict
...
input double Trail_ATR_Multi    = 1.5;            //Trail SL offset from BB mid (ATR multiples) [was 0.8 in v120]
...
input int    Magic_Number       = 1312025;        //Magic Number
input string Order_Comment      = "BSv131";       //Order comment
