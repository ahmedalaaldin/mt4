//+------------------------------------------------------------------+
//|   Buy & Sell EA v382 - Max_Bars=25 test (fine-tune around 20-22)   |
...
input int    Max_Bars           = 25;             // v382: fine-tune above 22
...
input int    Magic_Number       = 3822057;        // v382 unique magic
input string Order_Comment      = "BSv382";
