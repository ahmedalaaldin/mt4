//+------------------------------------------------------------------+
//|   Buy & Sell EA v120 - Wider Trail + Longer Hold                 |
//|   Framework: 4H Direction / 1H Structure / 5M Entry             |
//|   Base: v114 (gold standard 14.6x Return/DD ratio)              |
//|   Changes vs v114:                                               |
//|     - Trail_ATR_Multi: 0.8 (was 0.3) — wider trail offset       |
//|       gives remaining 50% more room to run after partial close   |
//|     - Max_Bars: 100 (was 60) — more time for position to play out|
//|   Hypothesis: wider trail + longer duration captures more of     |
//|   each move's full extension, improving per-trade profit and     |
//|   pushing Return/DD ratio above v114's 14.6x                    |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "130.0"
#property strict
...
input double Trail_ATR_Multi    = 0.8;            //Trail SL offset from BB mid (ATR multiples) [was 0.3 in v114]
input int    Max_Bars           = 100;            //Force close after N bars [was 60 in v114]
...
input int    Magic_Number       = 1302025;        //Magic Number
input string Order_Comment      = "BSv130";       //Order comment
