//+------------------------------------------------------------------+
//|   Buy & Sell EA v406 - Trail_ATR_Multi=0.35 (v393 was 0.5)|
...
input double Trail_ATR_Multi    = 0.35;           // v406: tighter trail from 0.5
...
input int    Magic_Number       = 4062057;        // v406 unique magic
input string Order_Comment      = "BSv406";
