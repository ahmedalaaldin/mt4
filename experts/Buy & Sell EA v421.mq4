...
input int    H4_EMA_Fast_Period = 50;             // v374: confirmed optimal
...
input int    Magic_Number       = 4212057;        // v412 unique magic
input string Order_Comment      = "BSv421";
