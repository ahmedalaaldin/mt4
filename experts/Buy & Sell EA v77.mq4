//+------------------------------------------------------------------+
//|   Buy & Sell EA v88 - H4 EMA200 added to proven v58 setup      |
//|   Entry: H4 EMA200 uptrend + H1 EMA200 + H1 RSI 50-75          |
//|          + BB 2.5SD lower touch + M5 RSI<40 + RSI rising        |
//|          + Stoch K&D<25 + Bull body 20%                         |
//|   Exit: TP = BB mid, SL = 1xATR                                 |
//|   Goal: Improve WR from 56% to 58-62% via H4 trend filter      |
//|   Key: First time BB 2.5SD + H4 EMA200 combination tested      |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "88.0"
#property strict
...
input int    Magic_Number       = 882025;         //Magic Number
input string Order_Comment      = "BSv88";        //Order comment
