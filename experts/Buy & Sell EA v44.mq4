//+------------------------------------------------------------------+
//|   Buy & Sell EA v55 - BB 2.5SD + 30% Body + 10% Risk           |
...
//|   Changes: Risk_Pct=10.0%, Max_Daily_DD_Pct=20.0%              |
//|   Goal: Push return ceiling with proven v42 signal              |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "55.0"
#property strict
...
input double Risk_Pct           = 10.0;           //Risk % per trade
...
input int    Magic_Number       = 552025;         //Magic Number
input string Order_Comment      = "BSv55";        //Order comment
input double Max_Daily_DD_Pct   = 20.0;           //Daily drawdown guard (% of equity)
