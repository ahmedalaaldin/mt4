//+------------------------------------------------------------------+
//|   Buy & Sell EA v204 - Tighter Daily DD Guard (5% from 8%)       |
...
//|       LESSON: Win-streak scaling in v186 (1.25x peak) actually    |
//|       IMPROVES Calmar vs flat. Compounding boost > DD amplification|
//|       Removing win scaling reduces return MORE than DD reduction.  |
//|       v186 scaling (1.10/1.25) is optimal for win-streak side.    |
//|   v204 HYPOTHESIS: Keep v186 win scaling, tighten daily DD guard  |
//|     v186/v203 both used Max_Daily_DD_Pct=8.0                      |
//|     v186 MaxDD=18.87% was caused by a few catastrophic loss days  |
//|       where anti-martingale scaling compounded downward rapidly    |
//|     Fix: Set Max_Daily_DD_Pct=5.0 (from 8.0)                     |
//|       A 5% daily equity drop triggers forced close + stop trading  |
//|       This caps the worst-case single-day contribution to MaxDD    |
//|       Expected: Slightly lower return (stops on rare bad days)     |
//|       but significantly lower MaxDD → potentially better Calmar   |
//|     All other parameters identical to v186 (proven optimal).       |
//|     Run with PERIOD = M5 in Strategy Tester.                       |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "204.0"
#property strict
...
input int    Magic_Number       = 2042034;        //Magic Number
input string Order_Comment      = "BSv204";       //Order comment
input double Max_Daily_DD_Pct   = 5.0;            //v204: Daily DD guard tightened: 5% (was 8%)
