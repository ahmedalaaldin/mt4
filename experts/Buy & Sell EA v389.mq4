//+------------------------------------------------------------------+
//|   Buy & Sell EA v389 - ATR_TP_Multi=2.0 test (tighter TP, faster cycling, base v381)   |
...
input double ATR_TP_Multi       = 2.0;            // v389: tighter TP to free slot faster
...
input int    Magic_Number       = 3892057;        // v381 unique magic
input string Order_Comment      = "BSv389";
