//+------------------------------------------------------------------+
//|   Buy & Sell EA v346 - Body_Pct=0.10 (was 0.20)                  |
...
//|                                                                   |
//|   v346 HYPOTHESIS: Body_Pct=0.10 (smaller recovery candles OK)   |
//|   Current 0.20 requires bull body ≥20% of candle range.         |
//|   Reducing to 0.10 accepts doji-like candles that still close    |
//|   above BB lower with rising RSI. If small-body BB-touch         |
//|   signals carry similar WR (>76.8%), we gain more trades.        |
//|   Expected: ~1000-1100 trades, WR ~84-86%, return ~34-38%.      |
//|                                                                   |
//|   v346 CHANGES from v343:                                        |
//|     Body_Pct: 0.20 → 0.10 (all three TF: M5, M15, M30)         |
//|                                                                   |
...
input double Body_Pct           = 0.10;           // v346: reduced from 0.20
...
input int    Magic_Number       = 3462057;        // v346 unique magic
input string Order_Comment      = "BSv346";
...
void OnTick()
{
   ...
   //=== M30 BUY (v343: same pattern on M30 timeframe) ===
