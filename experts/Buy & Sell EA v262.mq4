...
input double Trail_ATR_Multi    = 0.0;            // v262: SL exactly at bbMid (no buffer), max profit lock
...
input int    Magic_Number       = 2622057;
input string Order_Comment      = "BSv262";
