//+------------------------------------------------------------------+
//|   Buy & Sell EA v380 - ATR_Spike_Multi=2.2 test (base v374)   |
...
input double ATR_Spike_Multi    = 2.2;            // v380: test wider spike filter
...
input int    Magic_Number       = 3802057;        // v380 unique magic
input string Order_Comment      = "BSv380";
