//+------------------------------------------------------------------+
//|   Buy & Sell EA v54 - BB 2.5SD + 30% Body + 8% Risk            |
...
//|   Changes: Risk_Pct=8.0%, Max_Daily_DD_Pct=15.0%               |
//|   Goal: Scale best signal for higher return                     |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "54.0"
#property strict
...
input double Risk_Pct           = 8.0;            //Risk % per trade (raised from 4.0)
...
input int    Magic_Number       = 542025;         //Magic Number
input string Order_Comment      = "BSv54";        //Order comment
