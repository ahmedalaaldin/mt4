//+------------------------------------------------------------------+
//|   Buy & Sell EA v76 - BB 2.0SD wider entry, same quality gates  |
//|   Entry: H1 EMA200 + H1 RSI 50-75 + BB 2.0SD lower touch       |
//|          + M5 RSI<40 + RSI rising + Stoch K&D<25 + Bull 20%    |
//|   Exit: TP = BB mid, SL = 1xATR                                 |
//|   Changes: BB_Dev=2.0 (from 2.5) for ~3x more signals          |
//|   Goal: Test if RSI+Stoch filters hold WR at 2.0SD             |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "76.0"
#property strict
...
input double BB_Dev             = 2.0;            //BB standard deviations (wider net)
input double TP_Min_ATR         = 0.4;            //Min TP distance as ATR multiple
...
input int    Magic_Number       = 762025;         //Magic Number
input string Order_Comment      = "BSv76";        //Order comment
