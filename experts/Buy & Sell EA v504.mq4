...
input double DD_Budget          = 100.0;          // v504: disable scaling (was 3.8, reduces size too aggressively after losses)
...
input int    Magic_Number       = 5042057;        // v504 unique magic
input string Order_Comment      = "BSv504";
