//+------------------------------------------------------------------+
//|   Buy & Sell EA v94 - v77 + daily loss circuit breaker          |
...
//|   Change: Stop trading after Max_Daily_Losses losses per day    |
//|   Goal: Cut consecutive losses to 1-2, reduce DD below 5%      |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "94.0"
#property strict
...
input int    Max_Daily_Losses   = 1;              //Stop trading after this many losses/day
...
input int    Magic_Number       = 942025;         //Magic Number
input string Order_Comment      = "BSv94";        //Order comment
...
//+------------------------------------------------------------------+
int CountDailyLosses(datetime todayStart)
{
   int losses = 0;
...
void OnTick()
{
   ...
   if(Max_Daily_Losses > 0 && CountDailyLosses(today) >= Max_Daily_Losses) return;
