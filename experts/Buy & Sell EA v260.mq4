...
input double Trail_ATR_Multi    = 0.3;            // v260: tighter trail (0.5->0.3), testing trend from v253
input double Partial_Pct        = 0.20;           // v258: 20% partial at BB_mid, 80% rides trail
...
input int    Magic_Number       = 2602057;
input string Order_Comment      = "BSv260";
