//+------------------------------------------------------------------+
//|   Buy & Sell EA v392 - ATR_Period=20 (longer/smoother ATR for SL/TP/trail)|
...
input int    Magic_Number       = 3922057;        // v392 unique magic
input string Order_Comment      = "BSv392";
