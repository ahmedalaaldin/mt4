//+------------------------------------------------------------------+
//|   Buy & Sell EA v63 - v51 + Stoch K&D < 20 (deeper oversold)   |
//|   Entry: H1 EMA200 + H1 RSI 50-75 + BB 2.5SD lower touch       |
//|          + M5 RSI<40 + RSI rising + Stoch K&D<20 + Bull 20%    |
//|   Exit: TP = BB mid, SL = 1xATR                                |
//|   Changes: Stoch_OB=20 (from 25) for deeper oversold filter     |
//|   Goal: Push WR above 60% by requiring deeper oversold          |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "63.0"
#property strict
...
input double Stoch_OB           = 20.0;           //Stochastic oversold level (tightened from 25)
...
input int    Magic_Number       = 632025;         //Magic Number
input string Order_Comment      = "BSv63";        //Order comment
