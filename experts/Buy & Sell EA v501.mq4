...
#property copyright ""
#property link      ""
#property version   "501.0"  // [RECONSTRUCTED 2026-05-31 from v502: v500 Risk=3.0 + v501 tp=0 dynamic-close exits; may include minor v502 refinements]
#property strict
...
input double H1_RSI_Min         = 45.0;           // v502: enable H1 RSI min (uptrend zone)
input double H1_RSI_Max         = 75.0;           // v502: enable H1 RSI max (not overbought)
...
input double Risk_Pct           = 3.0;            // v500: 1.5->3.0 (recover return; clean exit compensates DD)
...
input int    Magic_Number       = 5012057;        // v501 unique magic
input string Order_Comment      = "BSv501";
