//+------------------------------------------------------------------+
//|   Buy & Sell EA v58 - Buy Only + 20% Body + 8% Risk            |
//|   Entry: H1 EMA200 + H1 RSI 50-75 + BB 2.5SD lower touch       |
//|          + M5 RSI<40 + RSI rising + Stoch K&D<25 + Bull 20%    |
//|   Exit: TP = BB mid, SL = 1xATR                                |
//|   Changes: Body_Pct=0.2 (from 0.3) for more trades, 8% Risk    |
//|   Goal: Increase trade count while maintaining buy-only quality  |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "58.0"
#property strict
...
input double Body_Pct           = 0.2;            //Min bull body as fraction of range (relaxed)
...
input int    Magic_Number       = 582025;         //Magic Number
input string Order_Comment      = "BSv58";        //Order comment
