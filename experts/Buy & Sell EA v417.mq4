...
//|     Risk_Pct=1.00, DD_Budget=3.8, H1_EMA_Period=200              |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "417.0"
#property strict
...
input double Risk_Pct           = 1.00;           // NON-NEGOTIABLE
...
input int    Magic_Number       = 4172057;        // v412 unique magic
input string Order_Comment      = "BSv417";
