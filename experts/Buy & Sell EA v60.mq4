//+------------------------------------------------------------------+
//|   Buy & Sell EA v71 - v58 + Risk 10% for max return             |
//|   Entry: H1 EMA200 + H1 RSI 50-75 + BB 2.5SD lower touch       |
//|          + M5 RSI<40 + RSI rising + Stoch K&D<25 + Bull 20%    |
//|   Exit: TP = BB mid, SL = 1xATR                                 |
//|   Changes: Risk_Pct=10% (from 7%) for maximum return            |
//|   Goal: ~700%+ return while maintaining 56% WR                  |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "71.0"
#property strict
...
input int    Magic_Number       = 712025;         //Magic Number
input string Order_Comment      = "BSv71";        //Order comment
