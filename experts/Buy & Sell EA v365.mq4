...
input double ATR_Spike_Multi    = 3.0;            // v365: TEST — loosened from 2.0 to allow moderate-volatility entries
...
input int    Magic_Number       = 3652057;        // v358 unique magic
input string Order_Comment      = "BSv365";
