//+------------------------------------------------------------------+
//|   Buy & Sell EA v29 - Multi-TF RSI Confluence (Buy Only)       |
//|   BUY: H1 EMA200 up + H1 RSI 50-70 (H1 bullish, not OB)       |
//|         + M5 BB lower touch + M5 RSI<40 + bullish close        |
//|         + TP >= 1xATR                                            |
//|   Best setup: short-term M5 pullback in healthy H1 uptrend     |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
...
input double H1_RSI_Max         = 75.0;           //H1 RSI max (H1 not overbought)
...
input double RSI_Buy            = 40.0;           //BUY: M5 RSI must be below this
...
input int    Magic_Number       = 292025;         //Magic Number
input string Order_Comment      = "BSv29";        //Order comment
...
void OnTick()
{
   ...
   //--- BUY: H1 bullish (EMA200 + RSI 50-75) + M5 BB touch + M5 RSI oversold
