//+------------------------------------------------------------------+
//|   Buy & Sell EA v41 - v35 Signal + Smart TP Extension           |
//|   Entry: H1 EMA200 + H1 RSI 50-75 + BB 2.5SD lower touch      |
//|          + M5 RSI<40 + Stoch K<25 + bullish close              |
//|   Exit: Smart TP – at BB mid, extend TP to BB upper,           |
//|         move SL to entry + 0.3xATR (lock small profit)         |
//|   Goal: v35 quality signal + higher avg win via TP extension   |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
...
input int    Magic_Number       = 412025;         //Magic Number
input string Order_Comment      = "BSv41";        //Order comment
...
//+------------------------------------------------------------------+
// When Bid >= BB midline and TP is still at BB mid (not yet extended):
// Lock SL at entry + Lock_Profit_ATR * ATR, extend TP to BB upper
