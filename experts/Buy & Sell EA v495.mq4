...
input double Trail_ATR_Multi    = 0.60;           // v495: Trail sweep 0.40->0.60
...
input int    Magic_Number       = 4952057;        // v495 unique magic
input string Order_Comment      = "BSv495";
