//+------------------------------------------------------------------+
//|   Buy & Sell EA v355 - ATR Spike Multi=1.5 (tighter filter)      |
...
//|                                                                   |
//|   v355 HYPOTHESIS: ATR_Spike_Multi=1.5 (tighter than v354=2.0). |
//|   If 2×ATR-average filtered ~4 bad trades and reduced MaxDD     |
//|   from 4.87→4.65%, then 1.5×ATR-average filters even more      |
//|   spike entries. The question: does the tighter threshold        |
//|   (filtering more trades) further reduce MaxDD or does it start  |
//|   cutting good trades too?                                       |
//|                                                                   |
//|   v355 CHANGES from v354:                                        |
//|     ATR_Spike_Multi: 2.0 → 1.5                                  |
//|                                                                   |
...
input double ATR_Spike_Multi    = 1.5;            // v355: tighter — block when ATR > 1.5× average
...
input int    Magic_Number       = 3552057;        // v355 unique magic
input string Order_Comment      = "BSv355";
...
void OnTick()
{
   ...
   // v355: ATR spike filter — skip when ATR > 1.5× rolling average (tighter than v354's 2.0×)
