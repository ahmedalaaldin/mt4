//+------------------------------------------------------------------+
//|   v400 - v393 + ATR_Spike_Multi=3.0: very permissive volatility filter           |
...
input double ATR_Spike_Multi    = 3.0;            // v400: very permissive volatility filter
...
input int    Magic_Number       = 4002057;        // v400 unique magic
input string Order_Comment      = "BSv400";
