//+------------------------------------------------------------------+
//|   Buy & Sell EA v412 - Trail_ATR_Multi=0.15 (sweep: 0.5→0.35→0.25→0.15)|
//|   BASE: v411 ALL-TIME BEST (ratio=9.50, MaxDD=4.32%) ✓          |
//|                                                                   |
...
//|     Session=9-21, Max_Sells=0, ATR_SL_Multi=0.70                |
...
input double ATR_SL_Multi       = 0.70;            // NON-NEGOTIABLE
input double ATR_TP_Multi       = 5.0;            // TP never hit; safety only
input double Trail_ATR_Multi    = 0.15;           // v412: sweep 0.5→0.35→0.25→0.15
...
input int    Magic_Number       = 4162057;        // v412 unique magic
input string Order_Comment      = "BSv416";
