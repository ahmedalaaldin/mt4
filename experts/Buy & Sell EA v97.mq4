//+------------------------------------------------------------------+
//|   Buy & Sell EA v97 - v92 without M15 RSI filter                 |
//|   Framework: 4H Direction / 1H Structure / 5M Entry             |
//|   Change from v92: Removed M15 RSI<50 filter                    |
//|   Goal: More trades by removing M15 pullback requirement         |
//|   All entry quality gates preserved (BB 2.5SD + RSI<40 + Stoch) |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "107.0"
#property strict
...
input int    Magic_Number       = 1072025;        //Magic Number
input string Order_Comment      = "BSv107";       //Order comment
...
void OnTick()
{
   ...
   // No M15 filter — H4+H1 trend + M5 quality gates sufficient
