...
input double Trail_ATR_Multi    = 0.40;           // v498: unchanged
...
input double Risk_Pct           = 1.50;           // v497: Trail=0.40 + Risk=1.50 combo
input double Fixed_Lot          = 0.0;
input int    Max_Buys           = 2;              // v498: 1->2 (double trade frequency toward 5/day target)
...
input int    Magic_Number       = 4982057;        // v498 unique magic
input string Order_Comment      = "BSv498";
