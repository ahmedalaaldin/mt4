//+------------------------------------------------------------------+
//|   Buy & Sell EA v409 - H4_EMA_Fast_Period=30 (tighter H4 trend)  |
...
input int    H4_EMA_Fast_Period = 30;             // v409: tighter H4 trend filter - reduces counter-trend entries
...
input int    Magic_Number       = 4092057;        // v409 unique magic
input string Order_Comment      = "BSv409";
