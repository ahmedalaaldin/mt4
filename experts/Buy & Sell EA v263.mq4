//+------------------------------------------------------------------+
//|   Buy & Sell EA v263 - ATR_TP_Multi 2.5->5.0 (remove TP ceiling)|
...
//|     v253: Trail 0.8->0.5 ATR -> Calmar=10.39 (marginal +0.06)   |
//|     v254: Bid-based trail 1.5ATR -> Calmar=6.96 (worse)         |
//|       Trail fires on tick noise; BB_mid trail is correct         |
//|     v255: RSI_Buy=35 -> Calmar=0.84 (catastrophic: only 66 trd) |
//|       RSI_Buy=40 was perfectly calibrated - too tight kills it   |
//|     v256: Partial_Pct=0.30 -> Calmar=10.53 *** NEW BEST ***     |
//|       Return=108.66%, MaxDD=10.32%, 331 records, Win=91.84%      |
//|       (331 includes partial close records counted separately)     |
//|     v257: Partial_Pct=0.00 -> Calmar=4.08 (CATASTROPHIC)        |
...
//|                                                                  |
//|   v263 HYPOTHESIS: ATR_TP_Multi 2.5->5.0                        |
//|     With Trail=0.1, bbMid trail IS the primary exit              |
//|     Hard TP at 2.5*ATR may cap strong trending moves             |
//|     Larger TP lets winners run further when price trends strongly |
//|     Trail catches reversal; TP only fires on powerful breakouts   |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "263.0"
#property strict
...
input double ATR_TP_Multi       = 5.0;            // v263: 2.5->5.0, remove hard TP ceiling
...
input int    Magic_Number       = 2632057;
input string Order_Comment      = "BSv263";
