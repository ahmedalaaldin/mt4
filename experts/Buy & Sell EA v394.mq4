//+------------------------------------------------------------------+
//|   Buy & Sell EA v394 - Scale cap 2.0: aggressive compounding in low-DD periods  |
...
input int    Magic_Number       = 3942057;        // v394 unique magic
input string Order_Comment      = "BSv394";
