//+------------------------------------------------------------------+
//|   Buy & Sell EA v373 - H4 EMA(60) + ATR_Spike_MA=60 test   |
...
input int    H4_EMA_Fast_Period = 60;             // v373: confirmed optimal
...
input int    ATR_Spike_MA_Period = 60;            // 60-bar rolling ATR average (~5h)
...
input int    Magic_Number       = 3732057;        // v373 unique magic
input string Order_Comment      = "BSv373";
