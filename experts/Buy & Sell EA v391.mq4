//+------------------------------------------------------------------+
//|   Buy & Sell EA v391 - No H4 EMA filter: pure H1 trend gate only   |
...
input int    Magic_Number       = 3912057;        // v381 unique magic
input string Order_Comment      = "BSv391";
...
void OnTick()
{
   ...
   // v391: H4 EMA filter removed — test whether H1 alone suffices as trend gate
   bool h4Bull = true;
