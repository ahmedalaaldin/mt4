//+------------------------------------------------------------------+
//|   Buy & Sell EA v123 - Tighter BB (2.2) + H1 RSI Filter Restored|
//|   Framework: 4H Direction / 1H Structure / 5M Entry             |
//|   Base: v120 (224.50%, 14.95% DD, 15.0x ratio, best quality)    |
//|   Changes vs v120:                                               |
//|     - BB_Dev: 2.2 (was 2.5) — more frequent BB touches          |
//|       At 2.2σ vs 2.5σ, touches occur ~2x more often             |
//|     - H1 RSI filter: RESTORED from v120                          |
//|   Why: v122 (no H1 RSI) boosted trades 47% but crashed quality: |
//|     DD 18.99%, PF 1.83, 9 consec losses. H1 RSI was essential.  |
//|   Hypothesis: Lower BB_Dev with quality filter intact gets more  |
//|   trades while keeping WR >90% and DD near v120's 14.95%        |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
...
input double BB_Dev             = 2.2;            //BB SD [was 2.5 in v120 — tighter for more signals]
...
input int    Magic_Number       = 1332025;        //Magic Number
...
void OnTick()
{
   ...
   //--- BUY logic: H4 bull + H1 price above EMA + H1 RSI in bull zone (restored from v120)
   ...
   //--- SELL logic: H4 bear + H1 price below EMA + H1 RSI in bear zone (restored from v120)
