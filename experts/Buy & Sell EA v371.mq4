//+------------------------------------------------------------------+
//|   Buy & Sell EA v371 - H4 EMA(55) bracket between 50 and 60      |
...
input int    H4_EMA_Fast_Period = 55;             // v371: bracket 50-60 peak (60=best so far)
...
input int    Magic_Number       = 3712057;        // v371 unique magic
input string Order_Comment      = "BSv371";
