//+------------------------------------------------------------------+
//|   Buy & Sell EA v362 - H1 Stochastic OS Threshold Tuned to 60             |
//|   BASE: v358 (H4_EMA50 + M5+M15+M30 + ATR_Spike=2.0) BEST âœ“    |
//|                                                                   |
...
//|     v358: +H4_EMA(50) â†’ +31.23%, MaxDD=4.61%âœ…, WR=85.48% BEST|
//|     v359: Max_Buys=2 â†’ +24.95%, MaxDD=5.05%âŒ  FAIL             |
//|     v360: H4 slope â†’ identical to v358 (slope always true)       |
//|                                                                   |
...
input double H1_Stoch_OS        = 60.0;           // Oversold threshold — only enter when %K < this (v362: raised 35→60)
...
input int    Magic_Number       = 3622057;        // v362 unique magic
input string Order_Comment      = "BSv362";
...
void OnTick()
{
   ...
   // v361: H1 Stochastic oversold gate â€” only enter when H1 %K is oversold
   double h1_stoch_k = iStochastic(NULL, PERIOD_H1, H1_Stoch_K, H1_Stoch_D, H1_Stoch_Slow,
                                    MODE_SMA, 0, MODE_MAIN, 1);
   bool h1StochOS = (h1_stoch_k < H1_Stoch_OS);
