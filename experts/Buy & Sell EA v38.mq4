//+------------------------------------------------------------------+
//|   Buy & Sell EA v49 - v24 Signal + Relaxed Stoch Threshold     |
//|   Entry: H1 EMA200 + H1 RSI 50-75 + BB 2.5SD lower touch       |
//|          + M5 RSI<40 + Stoch K&D<35 (relaxed from 25) + bull   |
//|   Exit: TP = BB mid, SL = 1xATR                                |
//|   Goal: More trades by relaxing Stoch threshold 25→35          |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
...
input double Stoch_OB           = 35.0;           //Stochastic oversold level (relaxed 25→35)
...
input int    Magic_Number       = 492025;         //Magic Number
input string Order_Comment      = "BSv49";        //Order comment
