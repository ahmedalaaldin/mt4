//+------------------------------------------------------------------+
//|   Buy & Sell EA v349 - Risk_Pct=1.0% (was 0.85%)                |
...
//|                                                                   |
//|   v349 HYPOTHESIS: Risk_Pct=1.0% (was 0.85%) → +17.6% more     |
//|   risk per trade should scale return proportionally.             |
//|   Expected return: ~36% (30.67 * 1.0/0.85).                     |
//|   Risk: MaxDD may exceed 5%. If so, tighten DD_Budget to         |
//|   compensate (e.g. 3.3% instead of 3.8%).                       |
//|                                                                   |
//|   v349 CHANGES from v343:                                        |
//|     Risk_Pct: 0.85 → 1.0                                         |
//|                                                                   |
...
input double Risk_Pct           = 1.0;            // v349: increased from 0.85
...
input int    Magic_Number       = 3492057;        // v349 unique magic
input string Order_Comment      = "BSv349";
