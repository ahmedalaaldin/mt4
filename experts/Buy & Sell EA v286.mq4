//+------------------------------------------------------------------+
//|   Buy & Sell EA v286 - Looser BB_Dev=2.0 for More Frequent Signals|
//|   Framework: H1 EMA direction + H1 RSI gate / M5 Entry          |
//|   HYPOTHESIS: v280 uses BB_Dev=2.5 (extreme band touch) with     |
//|     two-bar pattern giving 637 trades/year (~1.75/day). Testing  |
//|     BB_Dev=2.0 (less extreme, touched more often) with the same  |
//|     two-bar breakdown-recovery filter. Hypothesis: more frequent  |
//|     signals (~1000-1500/year) at slightly lower quality. Win rate |
//|     may drop from 94.5% to ~90% but trade count increases. If    |
//|     MaxDD stays below 15% and Calmar stays above 12, this        |
//|     advances the trade-count target.                             |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "286.0"
#property strict
...
//--- BB Entry Signal (BB_Dev=2.0 NON-NEGOTIABLE)
...
input int    Magic_Number       = 2862057;
input string Order_Comment      = "BSv286";
