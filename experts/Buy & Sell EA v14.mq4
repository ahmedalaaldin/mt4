//+------------------------------------------------------------------+
//|   Buy & Sell EA v25 - BUY ONLY BB+RSI Confluence               |
//|   BUY: H1 EMA200 up + M5 BB lower touch + RSI<40 + bullish     |
//|         + TP >= 1xATR                                            |
//|   NO SELL trades - XAUUSD is structurally bullish 2025-2026     |
//|   Pure buy-only to maximize WR and eliminate short drag          |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "25.0"
#property strict
...
input int    Magic_Number       = 252025;         //Magic Number
input string Order_Comment      = "BSv25";        //Order comment
...
void OnTick()
{
   ...
   //--- BUY ONLY: above H1 EMA200, BB lower touch AND RSI oversold AND bullish close
   if(Close[1] > h1_ema)
   {
