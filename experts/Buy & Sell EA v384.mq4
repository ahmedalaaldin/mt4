//+------------------------------------------------------------------+
//|   Buy & Sell EA v384 - ATR_Spike_MA=45 test (base v381, Max_Bars=22)   |
...
input int    ATR_Spike_MA_Period = 45;            // v384: test below 50 with Max_Bars=22
...
input int    Magic_Number       = 3842057;        // v384 unique magic
input string Order_Comment      = "BSv384";
