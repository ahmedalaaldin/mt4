...
input double Risk_Pct           = 2.00;           // v492: 0.90->2.00 (target 200%/yr)
input double Fixed_Lot          = 0.0;
input int    Max_Buys           = 2;              // v492: unlock concurrent entries
...
input int    Magic_Number       = 4922057;        // v492 unique magic
input string Order_Comment      = "BSv492";
