//+------------------------------------------------------------------+
//|   Buy & Sell EA v80 - H4 trend + Williams%R oversold filter     |
//|   Entry: H4 EMA200 + H1 EMA200 + H1 RSI 50-75 + BB 2.5SD      |
//|          + M5 RSI<40 + RSI rising + Stoch K&D<25 + Bull 20%    |
//|          + Williams%R < -80 (deeply oversold)                   |
//|   Exit: TP = BB mid, SL = 1xATR                                 |
//|   Goal: Push WR from 56% to 65%+ with extra quality gates      |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "80.0"
#property strict
...
input int    H4_EMA_Period      = 200;            //H4 EMA period (broader trend)
...
input double WPR_Level          = -80.0;          //Williams%R oversold threshold
...
input int    Magic_Number       = 802025;         //Magic Number
input string Order_Comment      = "BSv80";        //Order comment
...
void OnTick()
{
   ...
   // H4 and H1 dual trend confirmation
