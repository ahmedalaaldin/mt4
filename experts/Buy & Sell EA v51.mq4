//+------------------------------------------------------------------+
//|   Buy & Sell EA v62 - v47 Best + Risk 5% for lower DD           |
//|   Entry: H1 EMA200 + H1 RSI 50-75 + BB 2.5SD lower touch       |
//|          + M5 RSI<40 + RSI rising + Stoch K&D<25 + Bull 20%    |
//|   Exit: TP = BB mid, SL = 1xATR                                |
//|   Changes: Risk_Pct=5% (from 8%) to reduce drawdown             |
//|   Goal: Keep return >200% while pushing DD below 15%            |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "62.0"
#property strict
...
input double Risk_Pct           = 5.0;            //Risk % per trade (reduced from 8%)
...
input int    Magic_Number       = 622025;         //Magic Number
input string Order_Comment      = "BSv62";        //Order comment
