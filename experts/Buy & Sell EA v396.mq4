//+------------------------------------------------------------------+
//|   Buy & Sell EA v396 - v393 + scale cap 2.0: double partial close + aggressive compounding|
...
input int    Magic_Number       = 3962057;        // v396 unique magic
input string Order_Comment      = "BSv396";
...
double GetRiskScale()
{
   ...
   return MathMax(Min_Scale, MathMin(2.0, scale));
}
