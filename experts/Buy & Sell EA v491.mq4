...
input int    H4_EMA_Fast_Period = 60;             //|   Buy & Sell EA v491 - Partial_Pct=0.15 (sweep: 0.20->0.15) v374: confirmed optimal
...
input double Trail_ATR_Multi    = 0.12;           //|   Buy & Sell EA v491 - Partial_Pct=0.15 (sweep: 0.20->0.15) v412: sweep 0.5→0.35→0.25→0.15
input double Partial_Pct        = 0.05;           //|   Buy & Sell EA v491 - Partial_Pct=0.15 (sweep: 0.20->0.15) NON-NEGOTIABLE
...
input double Risk_Pct           = 0.90;           //|   Buy & Sell EA v491 - Partial_Pct=0.15 (sweep: 0.20->0.15) NON-NEGOTIABLE
...
input int    Magic_Number       = 4912057;        //|   Buy & Sell EA v491 - Partial_Pct=0.15 (sweep: 0.20->0.15) v412 unique magic
input string Order_Comment      = "BSv491";
