//+------------------------------------------------------------------+
//|   Buy & Sell EA v89 - v77 optimized risk for DD target          |
...
//|   Change: Risk 7% -> 3% to target DD <5% while keeping >200%  |
//|   Expected: ~230% return, ~4.8% DD at 58.70% WR (46 trades)   |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "89.0"
#property strict
...
input double Risk_Pct           = 3.0;            //Risk % per trade (reduced to target <5% DD)
...
input int    Magic_Number       = 892025;         //Magic Number
input string Order_Comment      = "BSv89";        //Order comment
