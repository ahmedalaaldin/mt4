//+------------------------------------------------------------------+
//|   Buy & Sell EA v69 - v51 + Risk 7% for higher return           |
//|   Entry: H1 EMA200 + H1 RSI 50-75 + BB 2.5SD lower touch       |
//|          + M5 RSI<40 + RSI rising + Stoch K&D<25 + Bull 20%    |
//|   Exit: TP = BB mid, SL = 1xATR                                 |
//|   Changes: Risk_Pct=7% (from 5%) to boost return                |
//|   Goal: ~385% return while keeping 56% WR and same entry logic  |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "69.0"
#property strict
...
input double Risk_Pct           = 7.0;            //Risk % per trade (raised from 5%)
...
input int    Magic_Number       = 692025;         //Magic Number
input string Order_Comment      = "BSv69";        //Order comment
