//+------------------------------------------------------------------+
//|   v399 - v393 + ATR_Spike_Multi=2.5: allow moderate volatility entries          |
...
input double ATR_Spike_Multi    = 2.5;            // v399: moderate volatility entries
...
input int    Magic_Number       = 3992057;        // v399 unique magic
input string Order_Comment      = "BSv399";
