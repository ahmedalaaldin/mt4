//+------------------------------------------------------------------+
//|   Buy & Sell EA v298 - Max_Bars 30→20 (tighter time filter)     |
//|   BASE: v293/v280 CHAMPION (Calmar=18.43, Return=220.62%, 637 T) |
//|   CHANGE: Max_Bars = 20 (was 30)                                 |
//|   RATIONALE:                                                      |
//|     v280→v293 proved that reducing Max_Bars (50→30) improved     |
//|     Calmar from 18.36 to 18.43. Continuing that direction:       |
//|     30→20 bars. Trades open >20 bars (100 min on M5) without     |
//|     hitting BB_mid are likely "stuck" mean reversions in a       |
//|     strong trend — these tend to be the lowest-quality trades    |
//|     that tie up capital and occasionally hit SL on a sustained   |
//|     trend continuation. Closing them at 20 bars frees capital,   |
//|     reduces exposure duration, and should reduce MaxDD slightly. |
//|   HYPOTHESIS: ~590-610 trades, win rate rises slightly,          |
//|     MaxDD reduces from 11.97% to ~11.0-11.5%,                   |
//|     Return stable ~215-225%, Calmar pushes toward 19-20.         |
//|   SCOREBOARD:                                                     |
...
//|     v297: Calmar=6.46  (Body_Pct=40% — filtered too much)        |
//|     v298: Max_Bars=20  — TARGET Calmar 19+                       |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "298.0"
#property strict
...
input double Body_Pct           = 0.20;   // Reverted to v293 value (0.20)
...
//--- Exit Settings — KEY CHANGE: Max_Bars = 20 (was 30)
...
input int    Max_Bars           = 20;   // KEY CHANGE: was 30, now 20
...
input int    Magic_Number       = 2982057;
input string Order_Comment      = "BSv298";
