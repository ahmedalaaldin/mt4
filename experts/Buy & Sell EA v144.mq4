//+------------------------------------------------------------------+
//|   Buy & Sell EA v144 - Scale_High=1.85 (nudge above 200% target) |
//|   Framework: H4 Direction / H1 RSI Structure / M5 Entry          |
//|   Base: v143 (197.57% / 42.41% rel DD, 85.53% WR)               |
//|   Changes vs v143:                                                |
//|     1. Scale_High: 1.75 → 1.85 (9.25% risk at high streak)      |
//|        v143 was 2.4% short of 200% target.                       |
//|        +0.10 scale increment should add ~8% return.              |
//|        Target: ~205-208% return.                                 |
//|   Unchanged from v143:                                            |
...
//|     Max_Daily_DD_Pct=15%                                         |
//|   Scale calibration (all tested same period, same symbol):       |
//|     v142: Scale_High=1.50, WS_High=4 → 169.89% / 39.93% DD     |
//|     v143: Scale_High=1.75, WS_High=5 → 197.57% / 42.41% DD     |
//|     v139: Scale_High=2.00, WS_High=6 → 217.62% / 46.34% DD     |
//|     v144: Scale_High=1.85, WS_High=5 → target ~205%+ / ~43% DD |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "144.0"
#property strict
...
input double Scale_High         = 1.85;           //Scale at high streak (was 1.75)
...
input int    Magic_Number       = 1442025;        //Magic Number
input string Order_Comment      = "BSv144";       //Order comment
...
double GetRiskScale()
{
   ...
   if(streak >= WinStreak_High)     return Scale_High;  // 1.85× at 5+ wins
