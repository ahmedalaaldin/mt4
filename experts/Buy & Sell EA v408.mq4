//+------------------------------------------------------------------+
//|   Buy & Sell EA v408 - Max_Bars=15 (faster exit, more capacity)  |
...
input int    Max_Bars           = 15;             // v408: shorter max hold - exit sooner, free capacity for new signals
...
input int    Magic_Number       = 4082057;        // v408 unique magic
input string Order_Comment      = "BSv408";
