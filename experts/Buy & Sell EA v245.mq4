//+------------------------------------------------------------------+
//|   Buy & Sell EA v245 - BB_Dev=2.0, Full v186 Filters Restored   |
...
//|       Stoch drop: win rate 89%→79% = losing strategy at 5% risk |
//|       LESSON: Stochastic is NON-NEGOTIABLE — confirmed essential |
//|       Trades: 258→674/year (BB_Dev=2.0 does add signals)        |
//|                                                                 |
//|   v245 HYPOTHESIS: BB_Dev=2.0 + ALL v186 filters restored      |
//|     Single change from v186: BB_Dev 2.5→2.0                    |
//|     Stochastic: RESTORED (critical for win rate)               |
//|     H1 RSI gate: RESTORED [45,75]/[25,55]                      |
//|     Risk_Pct: 7.0 (v186 CONFIRMED OPTIMUM)                     |
//|     Scale_Mid=1.10, Scale_High=1.25 (v186 CONFIRMED)           |
//|     Expected: ~300-400 trades/yr, win rate ~87-89%, TBD Calmar  |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "245.0"
#property strict
...
//--- H1 RSI Gate (v186 CONFIRMED OPTIMUM — RESTORED after v244 disaster)
...
//--- BB Entry Signal (v245: BB_Dev=2.0, only change from v186)
input string S1_SET             = "============"; //====== BB Signal ======
input int    BB_Period          = 20;
input double BB_Dev             = 2.0;            // v245: 2.5→2.0 (more touches, ~2-3x signals)
input int    RSI_Period         = 14;
input double RSI_Buy            = 40.0;           // v186 CONFIRMED
input double RSI_Sell           = 60.0;           // v186 CONFIRMED
input double Body_Pct           = 0.2;

//--- Stochastic Gate (v186 CONFIRMED — RESTORED, was causing ruin when removed)
...
//--- Money Management (v186 CONFIRMED: 7%)
...
//--- Anti-Martingale (v186 CONFIRMED)
...
input int    Magic_Number       = 2452055;
input string Order_Comment      = "BSv245";
...
void OnTick()
{
   ...
   //=== BUY: v186 full filter set + BB_Dev=2.0 ===
   ...
   //=== SELL: v186 full filter set + BB_Dev=2.0 ===
