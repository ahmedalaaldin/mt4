//+------------------------------------------------------------------+
//|   Buy & Sell EA v370 - H4 EMA(70) continue search above v369     |
...
input int    H4_EMA_Fast_Period = 70;             // v370: TEST 70 (60=best, 50=prior best)
...
input int    Magic_Number       = 3702057;        // v370 unique magic
input string Order_Comment      = "BSv370";
