//+------------------------------------------------------------------+
//|   Buy & Sell EA v405 - RSI_Buy=40 (v393 had 45, stricter entry)  |
//|   BASE: v393 (ratio=8.83) CHANGE: RSI_Buy 45->40 fewer signals   |
//|                                                                   |
...
input double RSI_Buy            = 40.0;           // v405: tighter from 45 to 40
...
input int    Magic_Number       = 4052057;        // v405 unique magic
input string Order_Comment      = "BSv405";
