...
input double Trail_ATR_Multi    = 0.40;           // v494: 0.12->0.40 let winners run more (improve R:R)
...
input int    Magic_Number       = 4972057;        // v497 unique magic
input string Order_Comment      = "BSv497";
