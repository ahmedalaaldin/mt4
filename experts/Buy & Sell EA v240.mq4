//+------------------------------------------------------------------+
//|   Buy & Sell EA v240 - v186 Base + Risk_Pct 8.5%                |
...
//|       H4 RSI selects harder setups, avg loss: -1164 vs -827    |
...
//|       Return=178.59%, MaxDD=21.19%.                            |
//|       H4 RSI MaxDD driven by volatility, not scaling           |
//|     v239: Tighter H4 RSI [45,65]/[35,55] -> Cal=8.25           |
//|       Return=159.30%, MaxDD=19.31%. Narrower range filters      |
//|       too many good trades. Return -48% for only -3% MaxDD     |
//|                                                                 |
//|   v240 HYPOTHESIS: v186 base + Risk_Pct=8.5%                  |
//|     H4 RSI gate is DROPPED — it cannot achieve 200%+Return     |
//|     AND <22% MaxDD simultaneously.                              |
//|     v186 is the proven best base (Cal=12.60).                  |
//|     Linear risk scaling: 8.5/7.0 = 1.214x multiplier          |
//|     Expected return: ~217% (8.5/7.0 × 179.11%)                |
//|     Expected MaxDD: ~17.25% (8.5/7.0 × 14.21%)                |
//|     Calmar preserved at ~12.60 by construction                 |
//|     Anti-martingale RESTORED: Scale_Mid=1.10, Scale_High=1.25  |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "240.0"
#property strict
...
//--- Money Management (v240: Risk scaled from 7.0% to 8.5%)
input string MONEY_SET          = "============"; //====== Money Management ======
input double Risk_Pct           = 8.5;            // v240: 8.5% (was 7.0%) — to push return to 200%+
...
input int    Magic_Number       = 2402050;
input string Order_Comment      = "BSv240";
