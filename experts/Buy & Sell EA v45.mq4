//+------------------------------------------------------------------+
//|   Buy & Sell EA v56 - v42 Signal + RSI Rising Filter + 8% Risk  |
//|   Entry: H1 EMA200 + H1 RSI 50-75 + BB 2.5SD lower touch       |
//|          + M5 RSI<40 AND RSI rising (RSI[1]>RSI[2])             |
//|          + Stoch K&D<25 + Bull body >= 30% of candle range      |
//|   Exit: TP = BB mid, SL = 1xATR                                |
//|   Goal: RSI turning up from oversold = stronger reversal signal  |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
...
input int    Magic_Number       = 562025;         //Magic Number
input string Order_Comment      = "BSv56";        //Order comment
...
void OnTick()
{
   ...
   bool rsiRising = (rsi1 > rsi2);                // RSI turning up = reversal confirmation
