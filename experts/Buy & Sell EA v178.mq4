//+------------------------------------------------------------------+
//|   Buy & Sell EA v178 - Push to 200%+ Return (Risk 3.5%->4.0%)       |
...
input double Risk_Pct           = 4.0;            //Risk%: 4.0 (increased from 3.5 to cross 200% return target)
...
input int    Magic_Number       = 1782025;        //Magic Number
input string Order_Comment      = "BSv178";       //Order comment
