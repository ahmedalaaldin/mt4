...
input double Risk_Pct           = 3.00;           // v493: 0.90->3.00 (max return push)
input double Fixed_Lot          = 0.0;
input int    Max_Buys           = 2;              // v493: unlock concurrent entries
...
input int    Magic_Number       = 4932057;        // v493 unique magic
input string Order_Comment      = "BSv493";
