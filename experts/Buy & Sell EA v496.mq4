...
input double Risk_Pct           = 1.20;           // v496: Trail=0.40 + Risk=1.20 combo
...
input int    Magic_Number       = 4962057;        // v496 unique magic
input string Order_Comment      = "BSv496";
