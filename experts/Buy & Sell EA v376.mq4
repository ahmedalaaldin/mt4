//+------------------------------------------------------------------+
//|   Buy & Sell EA v376 - H1_RSI_Min=30 test (base: v374)   |
...
input int    Max_Bars           = 20;             // v374: test faster exit/reentry
...
input int    Magic_Number       = 3762057;        // v376 unique magic
input string Order_Comment      = "BSv376";
