//+------------------------------------------------------------------+
//|   Buy & Sell EA v361 - H1 Stochastic Oversold Filter             |
...
input double H1_Stoch_OS        = 35.0;           // Oversold threshold — only enter when %K < this
...
input int    Magic_Number       = 3612057;        // v361 unique magic
input string Order_Comment      = "BSv361";
...
void OnTick()
{
   ...
   // v361: H1 Stochastic oversold gate — only enter when H1 %K is oversold
