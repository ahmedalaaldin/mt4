//+------------------------------------------------------------------+
//|   Buy & Sell EA v404 - RSI_Buy=50 (v393 had 45, looser entry)    |
//|   BASE: v393 (ratio=8.83) CHANGE: RSI_Buy 45→50 more signals     |
//|                                                                   |
...
input double RSI_Buy            = 50.0;           // v404: raised from 45 to 50
...
input int    Magic_Number       = 4042057;        // v404 unique magic
input string Order_Comment      = "BSv404";
