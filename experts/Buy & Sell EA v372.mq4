//+------------------------------------------------------------------+
//|   Buy & Sell EA v369 - H4 EMA(60) fine-tune above v358 optimum   |
...
input int    H4_EMA_Fast_Period = 60;             // v369: TEST 60 (50=best, 20=bad)
...
input int    ATR_Spike_MA_Period = 40;            // v372: TEST 40 (50=prior, H4=60 base)
...
input int    Magic_Number       = 3722057;        // v372 unique magic
input string Order_Comment      = "BSv372";
