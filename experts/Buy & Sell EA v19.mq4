//+------------------------------------------------------------------+
//|   Buy & Sell EA v30 - Multi-TF RSI Confluence + Higher Risk     |
//|   BUY: H1 EMA200 up + H1 RSI 50-80 (wider H1 window)          |
//|         + M5 BB lower touch + M5 RSI<42 + bullish close        |
//|         + TP >= 1xATR                                            |
//|   v18 best: PF=1.13 → v19 target: more trades + higher return  |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
...
input double H1_RSI_Min         = 50.0;           //H1 RSI min (H1 must be bullish)
input double H1_RSI_Max         = 80.0;           //H1 RSI max (wider: was 75)
...
input double RSI_Buy            = 42.0;           //BUY: M5 RSI must be below this (was 40)
...
input double Risk_Pct           = 2.5;            //Risk per trade (% of equity) — scaled up
...
input int    Magic_Number       = 302025;         //Magic Number
input string Order_Comment      = "BSv30";        //Order comment
...
void OnTick()
{
   ...
   //--- BUY: H1 bullish (EMA200 + RSI 50-80) + M5 BB touch + M5 RSI oversold
