//+------------------------------------------------------------------+
//|   Buy & Sell EA v351 - Max_Bars=50 (was 30)                      |
...
//|                                                                   |
//|   v351 HYPOTHESIS: Max_Bars=50 (was 30, ~2.5h → ~4.2h).        |
//|   Some trades in temporary drawdown recover AFTER bar 30 but    |
//|   are force-closed too early as losses. Giving 50 bars allows   |
//|   more time for the trailing SL logic to work.                  |
//|   Expected: some "time-exit" losses convert to wins → higher WR |
//|   and avg_win. Max_Bars 30 cut borderline trades prematurely.   |
//|   Risk: losing trades may accrue more loss before SL hit.       |
//|                                                                   |
//|   v351 CHANGES from v343:                                        |
//|     Max_Bars: 30 → 50                                            |
//|                                                                   |
...
input int    Max_Bars           = 50;             // v351: increased from 30
...
input int    Magic_Number       = 3512057;        // v351 unique magic
input string Order_Comment      = "BSv351";
