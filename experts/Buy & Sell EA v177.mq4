...
input double Risk_Pct           = 3.5;            //Risk%: 3.5 (increased from 2.0 for higher return)
...
input int    Magic_Number       = 1772025;        //Magic Number
input string Order_Comment      = "BSv177";       //Order comment
