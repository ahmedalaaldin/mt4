//+------------------------------------------------------------------+
//|   Buy & Sell EA v87 - Wider H1 RSI filter for more signals      |
//|   Entry: H1 EMA200 + H1 RSI 45-80 (widened from 50-75)         |
//|          + BB 2.5SD lower touch + M5 RSI<40 + RSI rising        |
//|          + Stoch K&D<25 + Bull body 20%                         |
//|   Exit: TP = BB mid, SL = 1xATR                                 |
//|   Goal: Get 70-90 trades/yr keeping 53%+ WR (vs 50 at 56% WR)  |
//|   Change: H1 RSI 50-75 -> 45-80 to catch more valid windows    |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "87.0"
#property strict
...
input double H1_RSI_Min         = 45.0;           //H1 RSI min (widened - allows near-neutral)
input double H1_RSI_Max         = 80.0;           //H1 RSI max (widened - allows near-overbought)
...
input int    Magic_Number       = 872025;         //Magic Number
input string Order_Comment      = "BSv87";        //Order comment
