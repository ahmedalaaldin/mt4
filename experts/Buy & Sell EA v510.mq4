...
input double DD_Budget          = 4.5;            // v510: 100->4.5 (RE-ENABLE governor on v509 high-risk; cap DD ~5%)
...
input int    Magic_Number       = 5102057;        // v510 unique magic
input string Order_Comment      = "BSv510";
