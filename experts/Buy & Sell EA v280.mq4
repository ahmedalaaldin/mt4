//+------------------------------------------------------------------+
//|   Buy & Sell EA v280 - Two-bar BB Breakdown-Recovery Pattern     |
//|   Framework: H1 EMA direction + H1 RSI gate / M5 Entry          |
//|   HYPOTHESIS: A single bar[1] touching BB2.5σ is the current    |
//|     signal. A STRONGER signal requires bar[2] to have CLOSED    |
//|     BELOW the BB lower (breakdown bar) AND bar[1] to touch it   |
//|     but CLOSE ABOVE (recovery bar). This two-bar "breakdown      |
//|     then recovery" pattern is a classic mean-reversion setup:    |
//|     bears pushed price past the band, but buyers defended it on  |
//|     the very next bar. Should increase win rate at cost of       |
//|     fewer trades → lower MaxDD, higher Calmar.                  |
//|   BASE: v269 CHAMPION (Calmar=17.77, Return=209%, 707 trades)   |
//|   CHANGE: Add bbPrevBreak (bar[2] closed below BB lower for     |
//|     buys, above BB upper for sells)                             |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "280.0"
#property strict
...
//--- Two-bar pattern settings (NEW in v280)
...
input int    Magic_Number       = 2802057;
input string Order_Comment      = "BSv280";
