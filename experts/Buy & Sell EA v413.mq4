//+------------------------------------------------------------------+
//|   Buy & Sell EA v413 - Trail_ATR_Multi=0.10 (sweep: 0.5→0.35→0.25→0.15→0.10)|
//|   BASE: v412 ALL-TIME BEST (ratio=9.89, MaxDD=4.34%) ✓          |
//|                                                                   |
...
//|                                                                   |
//|   Trail_ATR_Multi sweep results:                                 |
//|     0.50 (v393) → ratio=8.83, MaxDD=4.54%                       |
//|     0.35 (v406) → ratio=9.10, MaxDD=4.38%                       |
//|     0.25 (v411) → ratio=9.50, MaxDD=4.32%                       |
//|     0.15 (v412) → ratio=9.89, MaxDD=4.34% ← BEST SO FAR        |
//|     0.10 (v413) → testing...                                     |
//|                                                                   |
//|   NON-NEGOTIABLES (ALL unchanged):                               |
//|     BB_Dev=2.5, BB_Period=20, TwoBar_Lookback=1                  |
//|     Session=9-21, Max_Sells=0, ATR_SL_Multi=0.80                |
//|     Partial_Pct=0.20, Hard_DD_Stop=0.0                          |
//|     RSI_Buy=45.0, RSI_Period=14, Body_Pct=0.20                   |
//|     Risk_Pct=0.85, DD_Budget=3.8, H1_EMA_Period=200              |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "413.0"
#property strict
...
input double Trail_ATR_Multi    = 0.10;           // v413: sweep 0.5→0.35→0.25→0.15→0.10
...
input int    Magic_Number       = 4132057;        // v413 unique magic
input string Order_Comment      = "BSv413";
