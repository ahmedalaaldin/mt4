//+------------------------------------------------------------------+
//|   Buy & Sell EA v53 - BB 2.5SD + 30% Body Filter + 4% Risk     |
...
//|   Goal: Quality filter on proven v24 signal + risk scaling      |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "53.0"
#property strict
...
input double BB_Dev             = 2.5;            //BB standard deviations (proven optimal)
...
input int    Magic_Number       = 532025;         //Magic Number
input string Order_Comment      = "BSv53";        //Order comment
