//+------------------------------------------------------------------+
//|   Buy & Sell EA v266 - Stricter Body Filter: Body_Pct=0.5       |
...
//|     ATR_Spike_Multi=1.8 (v265 proved loosening destroys Calmar)  |
//|                                                                  |
//|   v263: Body_Pct=0.2, TP=5.0 -> Calmar=10.98 *** CHAMPION ***  |
//|     Return=111.58%, MaxDD=10.16%, 472 trades, Win=94.28%         |
//|   v265: Body_Pct=0.0, Spike=2.5 -> Calmar=6.57 (CATASTROPHIC)  |
//|     MaxDD jumped to 23.92%, losses: 27->41 (+52% losers)        |
//|     LESSON: Body filter + spike filter are ESSENTIAL quality     |
//|                                                                  |
//|   v266 HYPOTHESIS: Stricter body filter (0.2->0.5)              |
//|     Only enter on strong impulsive reversal candles              |
//|     Candle body >= 50% of total range (vs 20% in v263)          |
//|     Eliminates weak doji/indecisive candles at BB touch          |
//|     These weak-body candles likely = entries that hit full SL    |
//|     Fewer trades but potentially much better win% and Calmar     |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "266.0"
#property strict
...
input double Body_Pct           = 0.5;    // v266: 0.2->0.5, strong impulsive candle only
...
input double ATR_Spike_Multi    = 1.8;    // CONFIRMED OPTIMAL (v265 proved loosening destroys)
...
input int    Magic_Number       = 2662057;
input string Order_Comment      = "BSv266";
...
void OnTick()
{
   ...
   //=== BUY: v266 - Stricter body filter (0.5 = strong impulsive candle) ===
   ...
   //=== SELL: v266 - Stricter body filter (0.5 = strong impulsive candle) ===
