//+------------------------------------------------------------------+
//|   Buy & Sell EA v52 - BB 2.0SD + 30% Body Filter + 4% Risk     |
//|   Entry: H1 EMA200 + H1 RSI 50-75 + BB 2.0SD lower touch       |
//|          + M5 RSI<40 + Stoch K&D<25                             |
//|          + Bull body >= 30% of candle range                     |
//|   Exit: TP = BB mid, SL = 1xATR                                |
//|   Goal: More trades via BB 2.0SD, quality via body filter       |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "52.0"
#property strict
...
input double BB_Dev             = 2.0;            //BB standard deviations (relaxed from 2.5)
...
input double Body_Pct           = 0.3;            //Min bull body as fraction of candle range
...
input double Risk_Pct           = 4.0;            //Risk % per trade
...
input int    Magic_Number       = 522025;         //Magic Number
input string Order_Comment      = "BSv52";        //Order comment
input double Max_Daily_DD_Pct   = 8.0;            //Daily drawdown guard (% of equity)
...
void OnTick()
{
   ...
   if(bbTouch && rsiOS && stochOS && strongBull)
   {
