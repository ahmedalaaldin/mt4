//+------------------------------------------------------------------+
//|   Buy & Sell EA v98 - Remove H1 RSI + Bull Body filters         |
//|   Framework: 4H Direction / 1H EMA Structure / 15M / 5M Entry   |
//|   Changes from v92:                                              |
//|     - Removed H1 RSI 50-75 filter (allow all uptrend strengths) |
//|     - Removed bull body requirement (allow doji bounces)         |
//|     - Kept M15 RSI<50 (quality gate restored from v97)           |
//|   Goal: More entries in strong trends + doji bounces             |
//|   Core gates preserved: BB 2.5SD + RSI<40 + Stoch<25            |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "108.0"
#property strict
...
input int    H1_RSI_Period      = 14;             //H1 RSI period (unused - kept for reference)
...
input int    Magic_Number       = 1082025;        //Magic Number
input string Order_Comment      = "BSv108";       //Order comment
...
void OnTick()
{
   ...
   if(bbTouch && rsiOS && rsiRising && stochOS)
   {
