//+------------------------------------------------------------------+
//|   Buy & Sell EA v348 - ATR_TP_Multi=8.0 (was 5.0)               |
...
//|                                                                   |
//|   v348 HYPOTHESIS: ATR_TP_Multi=8.0 → let winners run further   |
//|   Current TP=5*ATR caps strong momentum trades too early.        |
//|   Most exits are via trailing SL anyway, not TP.                 |
//|   For the subset of trades where price runs >5*ATR, extending   |
//|   TP to 8*ATR allows trailing SL to capture more profit.        |
//|   Expected: same # trades, higher avg_win, better return.        |
//|   MaxDD unchanged (TP doesn't affect losing trades).             |
//|                                                                   |
//|   v348 CHANGES from v343:                                        |
//|     ATR_TP_Multi: 5.0 → 8.0                                      |
//|                                                                   |
...
input double ATR_TP_Multi       = 8.0;            // v348: increased from 5.0
...
input int    Magic_Number       = 3482057;        // v348 unique magic
input string Order_Comment      = "BSv348";
