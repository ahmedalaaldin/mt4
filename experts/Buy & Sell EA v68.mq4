//+------------------------------------------------------------------+
//|   Buy & Sell EA v79 - v58 entry + early breakeven at 0.5xATR   |
//|   Entry: H1 EMA200 + H1 RSI 50-75 + BB 2.5SD lower touch       |
//|          + M5 RSI<40 + RSI rising + Stoch K&D<25 + Bull 20%    |
//|   Exit: TP = BB mid, SL = 1xATR, BE move after 0.5xATR profit  |
//|   Changes: Converts near-miss losses to scratch BE trades       |
//|   Goal: Reduce DD by protecting profits early, keep v58 WR     |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "79.0"
#property strict
...
input double ATR_BE_Multi       = 0.5;            //Move to breakeven after ATR x this profit
...
input int    Magic_Number       = 792025;         //Magic Number
input string Order_Comment      = "BSv79";        //Order comment
...
{
   if(atr <= 0) return;
   double beTrigger = ATR_BE_Multi * atr; // 0.5xATR profit triggers BE move
