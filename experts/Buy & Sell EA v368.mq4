//+------------------------------------------------------------------+
//|   Buy & Sell EA v368 - Dual H4 EMA(50>200) trend gate            |
...
input int    H4_EMA_Fast_Period = 50;             // v368: reverted to 50; dual EMA(50>200) added
...
input int    Magic_Number       = 3682057;        // v368 unique magic
input string Order_Comment      = "BSv368";
...
void OnTick()
{
   ...
   // v368: Dual H4 EMA(50>200) trend gate — ema_fast > ema_slow confirms medium-term uptrend
   double h4_ema_fast = iMA(NULL, PERIOD_H4, H4_EMA_Fast_Period, 0, MODE_EMA, PRICE_CLOSE, 1);
   double h4_ema_slow = iMA(NULL, PERIOD_H4, H4_EMA_Period,      0, MODE_EMA, PRICE_CLOSE, 1);
   bool h4Bull = (iClose(NULL, PERIOD_H4, 1) > h4_ema_fast) && (h4_ema_fast > h4_ema_slow);
