//+------------------------------------------------------------------+
//|   Buy & Sell EA v173 - BB 2.0 SD for Higher Signal Frequency     |
//|   Framework: H4 Direction / H1 RSI Structure / M5 Entry         |
//|   LESSONS:                                                        |
//|     v171: Removed H4/H1 EMA filter => WR 81%->73%, DD->18%      |
//|     v172: M1 timeframe => WR 81%->56%, Return -41%, DD 42%       |
//|     Conclusion: M5 + H4/H1 EMA filter is the ONLY proven combo  |
//|   APPROACH v173:                                                  |
//|     Return to M5 (proven 81% WR with BB/RSI signals)             |
//|     Reduce BB_Dev from 2.5 -> 2.0 SD                             |
//|     Lower SD = price is outside bands more often (~5% vs ~1%)   |
//|     Expect 3-5x more signals: ~1000-1800 trades/year             |
//|     If WR holds at 70-75%: better total return possible          |
//|     Risk_Pct reduced to 1.0 to control DD with higher frequency  |
//|   Changes vs v172:                                               |
//|     1. BB_Dev: 2.5 -> 2.0 (KEY: 3-5x more M5 signals)          |
//|     2. Risk_Pct: 0.7 -> 1.0 (rebalanced for M5 frequency)       |
//|     3. Magic_Number: 1722025 -> 1732025                          |
//|     4. Order_Comment: BSv172 -> BSv173                           |
//|     5. Test on M5 in Strategy Tester (back to proven timeframe)  |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "173.0"
#property strict
...
input double BB_Dev             = 2.0;            //BB SD: 2.0 (more signals vs 2.5)
...
input double Risk_Pct           = 1.0;            //Risk%: 1.0 (balanced for M5 high freq)
...
input int    Magic_Number       = 1732025;        //Magic Number
input string Order_Comment      = "BSv173";       //Order comment
