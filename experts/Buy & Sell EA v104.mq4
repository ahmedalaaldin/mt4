//+------------------------------------------------------------------+
//|   Buy & Sell EA v104 - Gated Second Position for DD Control      |
//|   Framework: 4H Direction / 1H Structure / 5M Entry             |
//|   Base: v102 partial exit + trailing stop + streak scaling       |
//|   Innovation:                                                    |
//|     - BUY only (SELL removed — hurts in trending market)        |
//|     - Risk_Pct = 4.9% (single position loss stays below 5%)     |
//|     - Max_Buys = 2 but gated: 2nd opens ONLY when 1st is at    |
//|       breakeven (SL >= openPrice), meaning 1st is risk-free     |
//|     - Max concurrent live risk = ONE position = 4.9% always     |
//|   Goal: Keep 200%+ return while guaranteeing DD below 5%        |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "114.0"
#property strict
...
input double Risk_Pct           = 4.9;            //Base risk % per trade (single trade < 5% DD)
...
input int    Magic_Number       = 1142025;        //Magic Number
input string Order_Comment      = "BSv114";       //Order comment
