//+------------------------------------------------------------------+
//|   Buy & Sell EA v60 - Buy Only + 20% Body + H1 RSI 45-80       |
//|   Entry: H1 EMA200 + H1 RSI 45-80 + BB 2.5SD lower touch       |
//|          + M5 RSI<40 + RSI rising + Stoch K&D<25 + Bull 20%    |
//|   Exit: TP = BB mid, SL = 1xATR                                |
//|   Changes: H1 RSI range expanded 50-75 -> 45-80 for more trades |
//|   Goal: More entries in early/late trend phases                  |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
...
input double H1_RSI_Min         = 45.0;           //H1 RSI min (expanded from 50)
input double H1_RSI_Max         = 80.0;           //H1 RSI max (expanded from 75)
...
input int    Magic_Number       = 602025;         //Magic Number
input string Order_Comment      = "BSv60";        //Order comment
