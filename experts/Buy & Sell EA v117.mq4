//+------------------------------------------------------------------+
//|   Buy & Sell EA v117 - No Stochastic Filter                     |
//|   Framework: 4H Direction / 1H Structure / 5M Entry             |
//|   Base: v114 (217.78%, 14.93% DD, 327 trades, 93.27% WR)       |
//|   Key change:                                                    |
//|     - Removed Stochastic OS/OB condition from BUY/SELL entry    |
//|     - Stoch was redundant with RSI<40 + BB lower touch          |
//|     - Goal: more trades, similar WR, higher absolute return     |
//|   Hypothesis: BB touch + RSI + body alone are sufficient;       |
//|     removing Stoch gives 30-50% more entries per year           |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "127.0"
#property strict
...
input double Risk_Pct           = 4.5;            //Risk % per trade (slightly reduced for lower WR)
...
input int    Magic_Number       = 1272025;        //Magic Number
input string Order_Comment      = "BSv127";       //Order comment
...
void OnTick()
{
   ...
   //--- BUY logic: Stochastic removed — BB touch + RSI + body sufficient
