//+------------------------------------------------------------------+
//|   Buy & Sell EA v35 - Triple Confirmation: BB + RSI + Stoch    |
//|   BUY: H1 EMA200 + H1 RSI 50-75 + M5 BB lower touch           |
//|         + M5 RSI<40 + Stoch K<25 + bullish close               |
//|   Triple oversold confluence → target WR > 50%                 |
//|   Higher WR allows higher risk for bigger annual return         |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
...
input double Risk_Pct           = 2.0;            //Risk % — higher since WR target >50%
...
input int    Magic_Number       = 352025;         //Magic Number
input string Order_Comment      = "BSv35";        //Order comment
