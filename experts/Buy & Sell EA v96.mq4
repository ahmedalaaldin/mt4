//+------------------------------------------------------------------+
//|   Buy & Sell EA v96 - Relaxed Filters for Higher Trade Frequency |
//|   Framework: 4H Direction / 1H Structure / 15M Setup / 5M Entry |
//|   Changes from v92:                                              |
//|     - BB_Dev 2.5 → 2.0 (more frequent band touches)             |
//|     - Removed Stochastic filter (redundant w/ RSI)              |
//|     - RSI_Buy 40 → 50 (more entries during moderate pullbacks)  |
//|     - Removed bull body requirement (too restrictive)           |
//|   Goal: Increase trade frequency while preserving WR            |
//+------------------------------------------------------------------+
#property copyright ""
#property link      ""
#property version   "106.0"
#property strict
...
input double BB_Dev             = 2.0;            //BB SD (relaxed from 2.5 for more signals)
...
input double RSI_Buy            = 50.0;           //M5 RSI max for BUY (relaxed from 40)
...
input int    Magic_Number       = 1062025;        //Magic Number
input string Order_Comment      = "BSv106";       //Order comment
...
void OnTick()
{
   ...
   // 15M: Setup (pullback confirmation)
